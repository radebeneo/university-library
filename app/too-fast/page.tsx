...
const Page = () => {
    return <main className="root-container flex min-h-screen flex-col items-center justify-center">
        ...
        <p className="mt-3 max-w-xl text-center text-light-400">Looks like you&apos;ve been . We&apos;ve put a temporary pause on your excitement. Chill for a bit, and try again shortly.</p>
    </main>
}
export default Page
